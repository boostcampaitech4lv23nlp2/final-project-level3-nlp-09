...
class CLIP(nn.Module):
    def __init__(
        ...
        self.text_projection = nn.Parameter(torch.empty(text_cfg.width, text_cfg.output_dim))
...
def build_model(vision_cfg: CLIPVisionCfg = CLIPVisionCfg(), text_cfg: CLIPTextCfg = CLIPTextCfg()):

    model = CLIP(vision_cfg=vision_cfg, text_cfg=text_cfg)
    return model
